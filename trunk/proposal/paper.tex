...
Though usage of machine learning algorithm seems to be very exciting approach at
this point, we are also skeptical about it. Supervised classifiers might not be
benficial for us due to the limited dataset for training and the potentialy
unlimited variety of inputs to classify. However, if we can use Graph
Based Partially Supervised Learning\cite{conf/acl/CelikyilmazTH09} or
Spreading Activation \cite{Cohen1987255} on the information extacted from the
rich ontologies is something we plan to explore.
