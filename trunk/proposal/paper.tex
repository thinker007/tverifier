...
We found that answer.com also contains truthful sentences for the doubt sentences in most of the cases. Hence using answer.com seems to be a good idea for the truthfulness verification. We can use similar strategies used for Wikipedia described in the section above.

\section{Progress up to now}
Following are the progress of us in these two weeks
\begin{itemize}
\item Formulated the procedure of truthfulness verification in a more structured and robust way compared to the last project proposal report
...
\item Read the documentation of the Freebase. The language for querying Freebase is called MQL and it is very complex in learn and apply for big project such as Truthfulness Verification. The documentation itself is also several hundred pages. However, we think that we will be able to use Freebase for our project in a successful way.
\end{itemize}
