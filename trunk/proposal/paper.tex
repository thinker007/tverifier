...
Now for each k-gram we find relevant wikipedia page. We will not get any wikipedia page for irrelevant k-gram combination.  Moreover, We may get a page directly or we may need to disambiguate. Following are the all relevant pages. The False in the second column means there is no ambiguation and True means we need to disambiguate.
